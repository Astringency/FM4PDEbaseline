...
COMMON=(--dry-run --synthetic-data --synthetic-resolution 32 --train-size 4 --batch-size 2 --epochs 1 --num-sensors 50 --sensor-mode random --noise-level 0.0 --output-dir outputs/baselines/smoke)
